                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="row g-3" action="{{ route('admin.custom-page-update', $custompage->id) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="parent_id" id="select2-1" class="form-control">
                                            <option
                                                value="0"{{ old('parent_id', $custompage->parent_id) == '0' ? 'selected' : '' }}>
                                                --Parent</option>
                                            @foreach ($custompages as $pages)
                                                <option
                                                    value="{{ $pages->id }}"{{ old('parent_id', $custompage->parent_id) == $pages->id ? 'selected' : '' }}>
                                                    {{ $pages->page_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="page_name"
                                            value="{{ old('page_name', $custompage->page_name) }}">
                                        @error('page_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="status" class="form-control">
                                            <option
                                                value="1"{{ old('status', $custompage->status) == 1 ? 'Selected' : '' }}>
                                                Publish
                                            </option>
                                            <option
                                                value="0"{{ old('status', $custompage->status) == 0 ? 'Selected' : '' }}>
                                                Draft</option>
                                        </select>
                                        @error('status')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="Show_in" class="form-control">
                                            <option
                                                value="0"{{ old('Show_in', $custompage->Show_in) == 0 ? 'Selected' : '' }}>
                                                Footer
                                            </option>
                                            <option
                                                value="1"{{ old('Show_in', $custompage->Show_in) == 1 ? 'Selected' : '' }}>
                                                Header
                                            </option>
                                            <option
                                                value="2"{{ old('Show_in', $custompage->Show_in) == 2 ? 'Selected' : '' }}>
                                                Both
                                            </option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            ...
                                            <input type="hidden" name="banner"
                                                value="{{ old('banner', $custompage->banner) }}" class="selected-files">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="priority"
                                            value="{{ old('priority', $custompage->priority) }}">
                                        @error('priority')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="basic-example" name="page_desc" class="form-control">{{ old('page_desc', $custompage->page_desc) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="meta_keyword"
                                            value="{{ old('meta_keyword', $custompage->meta_keyword) }}">
                                        @error('meta_keyword')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="meta_description" cols="4" rows="4">{{ old('meta_description', $custompage->meta_description) }}</textarea>
