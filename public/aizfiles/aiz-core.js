...
(function ($) {
    ...
    AIZ.data = {
        ...
        appWeb: $('meta[name="web-url"]').attr("content"),
        ...
        plusMinus: function(){
            ...
            $('.aiz-plus-minus input').on('change', function () {
                ...
                if (valueCurrent >= minValue) {
                    $(".input-group-btn-vertical [data-type='minus']").removeAttr("disabled");
                ...
                if (valueCurrent <= maxValue) {
                    $(".input-group-btn-vertical [data-type='plus']").removeAttr("disabled");
